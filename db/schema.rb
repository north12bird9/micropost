...
ActiveRecord::Schema.define(version: 20180216081031) do
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at",      null: false
    t.integer  "favorite_id"
    t.index ["favorite_id"], name: "index_users_on_favorite_id", using: :btree
  end
  ...
  add_foreign_key "users", "users", column: "favorite_id"
end
